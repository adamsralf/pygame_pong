...
class Help(pygame.sprite.Sprite):
    def __init__(self, *groups):
        ...
        text_r += "toggle pause mode\n"
        text_r += "toggle sound mode\n"
        text_r += "quit game\n\n"
        text_r += "toggle AI mode left player\n"
        text_r += "toggle AI mode right player\n\n"
        text_r += "move up left player\n"
        text_r += "move down left player\n"
        text_r += "move up right player\n"
        text_r += "move down right player"
...
class Ball(pygame.sprite.Sprite):
    ...
    def _service(self) -> None:
        ...
        self._speedxy.x = choice([-1, 1])
        self._speedxy.y = choice([-1, 1])
        self._speed = Settings.WINDOW.width // 3

    def _move(self) -> None:
        self.rect.move_ip(self._speedxy * self._speed * Settings.DELTATIME)
